...
def main():
    ...
    copyfile(filename,'b.db')
    copyfile(filename, 'f.db')
    copyfile(filename, 'w.db')

    num_of_programs = random.randint(30, 35)
    ...
    while programs_queue.empty() == False:
        ...
        best_fit(available_id_cc, r, cp, cpu_type, 'b.db')
